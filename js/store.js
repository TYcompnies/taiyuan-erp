...
const PERMISSIONS = [
    ...
    { code: "finance.ar", label: "进销存应收账款", group: "进销存账款/财务" },
    { code: "finance.ap", label: "进销存应付账款", group: "进销存账款/财务" },
    { code: "finance.bookkeeping", label: "财务会记（外挂记账系统）", group: "进销存账款/财务" },
    { code: "finance.quote", label: "商品估价试算（外挂跨境成本利润试算）", group: "进销存账款/财务" },
